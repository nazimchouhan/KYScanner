...
/*public class EventScanner extends AppCompatActivity {
    ...
    private Toolbar HospitalityToolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClassnameString= getIntent().getStringExtra("Class_name");
        if (eventName != null) {
            Log.e("EventScanner", "Received event: " + eventName);
            Toast.makeText(this, "Scanning for " + eventName, Toast.LENGTH_SHORT).show();
        }
        ScanProgressBar=findViewById(R.id.ScanprogressBar);
        HospitalityToolbar=findViewById(R.id.HospitalityToolbar);
        setSupportActionBar(HospitalityToolbar);
            ...
            try {
                ...
                imageAnalysis.setAnalyzer(cameraExecutor, image -> {
                    ...
                    if (mediaImage != null && !isQRCodeDetected) {
                        ...
                        //if (!isScanning && !isQRCodeDetected) {
        ...
        barcodeScanner.process(image)
                .addOnSuccessListener(barcodes -> {
                    ...
                    if (mainQrResult != null) {
                        ...
                        executor.execute(() -> {
                            Intent intent1=new Intent(EventScanner.this, TeamInfo.class);
                            intent1.putExtra("ky_id",mainQrResult);
                ...
                .addOnFailureListener(e -> {
                    ...
                    runOnUiThread(() -> Toast.makeText(this, "Error Fetching QR Code", Toast.LENGTH_SHORT).show());
                    isScanning = false;
                    imageProxy.close();
                });
    }
    private void showInvalidQRCodeOverlay() {
        ...
        runOnUiThread(() -> {
            if (!isOverlayShown){
                isOverlayShown = true;
                Intent intent = new Intent(EventScanner.this, EventInvalidUser.class);
    ...
    private final requestPermissionLauncher =
    ...
    public void onBackPressed() {
        super.onBackPressed();
                Intent intent2 = new Intent(EventScanner.this, EventList.class);
